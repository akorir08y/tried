...
public class TrustFundSummary {
    ...
    public void trustFundSummaryReport(HttpServletResponse OutputResponse) throws IOException {
        ...
        getTrustFundSummaryReport(summary_report);
    ...
    private void addHorizontalLine(Table invoice_header){
        ...
        invoice_header.addCell(new Cell().add("Full Trust Fund Summary Report "+Church_Name + " " + Month).setBorder(Border.NO_BORDER))
                .setFontSize(15)
                .setFont(bolden)
                .setWidthPercent(100)
                .setBold()
    ...
    private void getTrustFundSummaryReport(Table summaryReport) {
        ...
        summaryReport.addCell(new Cell().add("Receipt No")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);

        summaryReport.addCell(new Cell().add("Time")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);


        summaryReport.addCell(new Cell().add("Contributor Name")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);

        summaryReport.addCell(new Cell().add("Mode of Payment")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);

        summaryReport.addCell(new Cell().add("Tithe")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);

        summaryReport.addCell(new Cell().add("Combined")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);
        summaryReport.addCell(new Cell().add("Camp")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);

        summaryReport.addCell(new Cell().add("Conf Dev")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);

        summaryReport.addCell(new Cell().add("Thirteenth")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);

        summaryReport.addCell(new Cell().add("Total")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);

        summaryReport.addCell(new Cell().add("Balance")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);
        ...
        for(TransactionsItem transaction : transactions){
            ...
            if (transaction.getReceiptNumber() != null) {
                summaryReport.addCell(new Cell().add(transaction.getReceiptNumber())).setFontSize(10)
                        .setFont(bolden)
                        .setTextAlignment(TextAlignment.CENTER)
                        .setBorder(Border.NO_BORDER)
                        .setBackgroundColor(Color.WHITE);
            ...
            if(transaction.getTransactionDate() != null){
                summaryReport.addCell(new Cell().add(transaction.getTransactionDate())).setFontSize(10)
                        .setFont(bolden)
                        .setTextAlignment(TextAlignment.CENTER)
                        .setBackgroundColor(Color.WHITE);
            }else {
            ...
            if(transaction.getContributorName() != null){
                summaryReport.addCell(new Cell().add(transaction.getContributorName())).setFontSize(10)
                        .setFont(bolden)
                        .setTextAlignment(TextAlignment.CENTER)
                        .setBackgroundColor(Color.WHITE);
            ...
            if(transaction.getModeOfPayment() != null) {
                summaryReport.addCell(new Cell().add(transaction.getModeOfPayment())).setFontSize(10)
                        .setFont(bolden)
                        .setTextAlignment(TextAlignment.CENTER)
                        .setBackgroundColor(Color.WHITE);
            ...
            tithe.addCell(new Cell().add("Rcvd").setBorderRight(b2).setBorderBottom(b2)
                    .setBorderTop(Border.NO_BORDER).setBorderLeft(Border.NO_BORDER)).setBorder(Border.NO_BORDER);
            tithe.addCell(new Cell().add("Paid").setBorderLeft(b2).setBorderBottom(b2)
                    .setBorderTop(Border.NO_BORDER).setBorderRight(Border.NO_BORDER)).setBorder(Border.NO_BORDER);
            ...
            tithe.addCell(new Cell().add(String.valueOf(Double.parseDouble(transaction.getTithe()))).setBorderRight(b2).setBorderTop(Border.NO_BORDER)
                    .setBorderLeft(Border.NO_BORDER).setBorderBottom(Border.NO_BORDER)).setBorder(Border.NO_BORDER);
            tithe.addCell(new Cell().add(String.valueOf(Double.parseDouble(transaction.getTithePaid()))).setBorderLeft(b2).setBorderTop(Border.NO_BORDER)
                    .setBorderRight(Border.NO_BORDER).setBorderBottom(Border.NO_BORDER)).setBorder(Border.NO_BORDER);
            ...
            thirteenth.addCell(new Cell().add(String.valueOf(Double.parseDouble(transaction.getTotalReceiptedAmount()))).setBorderRight(b2).setBorderTop(Border.NO_BORDER)
                    .setBorderLeft(Border.NO_BORDER).setBorderBottom(Border.NO_BORDER)).setBorder(Border.NO_BORDER);
            thirteenth.addCell(new Cell().add(String.valueOf(Double.parseDouble(transaction.getTotalReceiptedAmountPaid()))).setBorderLeft(b2).setBorderTop(Border.NO_BORDER)
                    .setBorderRight(Border.NO_BORDER).setBorderBottom(Border.NO_BORDER)).setBorder(Border.NO_BORDER);
            ...
            summaryReport.addCell(new Cell().add(conf_dev)).setFontSize(10)
                    .setFont(bolden)
                    .setTextAlignment(TextAlignment.CENTER)
                    .setBackgroundColor(Color.WHITE);
