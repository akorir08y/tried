...
public class LocalChurchOfferingReport {
    ...
    public void LocalChurchSummaryReport(HttpServletResponse response, String phone_number,
                                          String start_date, String end_date, LocalChurchOfferingSummaryResponse responsed,
                                        String username,String password,String personnel_name,String institution_name,
                                         String institution_number,String institution_level) throws IOException {
        ...
        addHeaderData(table,institution_name,phone_number,institution_number);

        // Horizontal Header
        Table invoice_header = new Table(1);
        addHorizontalLine(invoice_header,start_date, end_date, institution_name);
    ...
    private void addHeaderData(Table table, String institution_name, String phone_number,String institution_number) throws JsonProcessingException {
