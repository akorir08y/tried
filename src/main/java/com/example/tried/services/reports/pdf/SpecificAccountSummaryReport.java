...
public class SpecificAccountSummaryReport {
    ...
    public void getSpecificAccountSummaryReport(String phoneNumber, HttpServletResponse OutputResponse, String start_date, String end_date,
                                          String username, String password, LocalChurchSpecificAccountSummaryResponse responsed) throws IOException {
        ...
        getSpecificAccountSummaryReport(summary_report,phoneNumber,responsed,start_date,end_date,username,password);
    ...
    private void getSpecificAccountSummaryReport(Table summaryReport, String start_date , LocalChurchSpecificAccountSummaryResponse specificAccount, String end_date,
        ...
        List<TransactionsItem> transactions = specificAccount.getSpecpayload().getTransactions();
