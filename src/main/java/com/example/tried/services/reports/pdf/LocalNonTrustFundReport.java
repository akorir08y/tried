...
public class LocalNonTrustFundReport {
    ...
    public void nonTrustFundSummaryReport(HttpServletResponse response, String phone_number,
                                          String start_date, String end_date, List<MembersItem> membersItems) throws IOException {
        ...
        Table summary_report = new Table(6);
        getTrustFundSummaryReport(summary_report,membersItems);
    ...
    private void getTrustFundSummaryReport(Table summaryReport, List<MembersItem> membersItems) {


        summaryReport.addCell(new Cell().add("Receipt Number")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);

        summaryReport.addCell(new Cell().add("Member Name")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);


        summaryReport.addCell(new Cell().add("Member Number")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);
        ...
        summaryReport.addCell(new Cell().add("Local Combined Offerings")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);

        summaryReport.addCell(new Cell().add("Total Amount")).setFontSize(10)
                .setFont(bolden)
                .setTextAlignment(TextAlignment.CENTER)
                .setBackgroundColor(Color.WHITE);
        ...
        for(MembersItem membersItem : membersItems){
            ...
            if (membersItem.getReceiptNumber() != null) {
                summaryReport.addCell(new Cell().add(membersItem.getReceiptNumber())).setFontSize(10)
                        .setFont(bolden)
                        .setTextAlignment(TextAlignment.CENTER)
                        .setBorder(Border.NO_BORDER)
                        .setBackgroundColor(Color.WHITE);
            ...
            if(membersItem.getMemberName() != null){
                summaryReport.addCell(new Cell().add(membersItem.getMemberName())).setFontSize(10)
                        .setFont(bolden)
                        .setTextAlignment(TextAlignment.CENTER)
                        .setBackgroundColor(Color.WHITE);
            }else {
            ...
            if(membersItem.getMemberNumber() != null){
                summaryReport.addCell(new Cell().add(membersItem.getMemberNumber())).setFontSize(10)
                        .setFont(bolden)
                        .setTextAlignment(TextAlignment.CENTER)
                        .setBackgroundColor(Color.WHITE);
            }else{
            ...
            if(membersItem.getMeansOfPayment() != null) {
                summaryReport.addCell(new Cell().add(membersItem.getMeansOfPayment())).setFontSize(10)
                        .setFont(bolden)
                        .setTextAlignment(TextAlignment.CENTER)
                        .setBackgroundColor(Color.WHITE);
            }else{
            ...
            if(membersItem.getLocalCombinedOfferings() != null) {
                summaryReport.addCell(new Cell().add(String.valueOf(membersItem.getLocalCombinedOfferings()))).setFontSize(10)
                        .setFont(bolden)
                        .setTextAlignment(TextAlignment.CENTER)
                        .setBackgroundColor(Color.WHITE);
            }else{
            ...
            if(membersItem.getTotalAmount() != null) {
                summaryReport.addCell(new Cell().add(membersItem.getTotalAmount())).setFontSize(10)
                        .setFont(bolden)
                        .setTextAlignment(TextAlignment.CENTER)
                        .setBackgroundColor(Color.WHITE);
            }else{
