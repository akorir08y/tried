...
public class TrustFundTranscriptReport {
    ...
    public void trustFundTranscriptReport(String phoneNumber, HttpServletResponse OutputResponse, String start_date, String end_date, TrustFundTranscriptResponse responsed, String conference_name
    ,String personnel_name, String institution_number, String institution_name) throws IOException {
        ...
        addHeaderData(table, institution_number, phoneNumber, institution_name, conference_name);
        ...
        getTrustFundTranscriptReport(summary_report,responsed);
    ...
    private void addHeaderData(Table table, String church_code,String phoneNumber, String church_name, String conference_name) throws JsonProcessingException {
    ...
    private void getTrustFundTranscriptReport(Table summaryReport, TrustFundTranscriptResponse transcript) throws JsonProcessingException {
