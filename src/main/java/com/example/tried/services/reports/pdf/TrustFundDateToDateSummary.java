...
public class TrustFundDateToDateSummary {
    ...
    public void trustFundSummaryReport(TrustFundSummaryDateToDatePaymentMode trustFundSummary, HttpServletResponse OutputResponse) throws IOException {
        ...
        personnel.setChurchCode(trustFundSummary.getPayload().getChurchCode());
    ...
    private void addHeaderData(Table table, TrustFundSummaryDateToDatePaymentMode trustFundSummary) throws JsonProcessingException {
        // Member Church Details Response
        String church_code = trustFundSummary.getPayload().getChurchCode();
