...
@Service
public class OfferingSpecificStatementService {
    // Resource Loader
    @Autowired
    ...
    @Autowired
    public OfferingSpecificStatementService(FileStorageProperties fileStorageProperties) {
    ...
    public void createOfferingStatement(SpecificOfferingStatement statement, HttpServletResponse OutputResponse) throws IOException {
        ...
        accountSummary(accounts,statement.getPayload().getAccountName());
    ...
    private void userInformation(Table table, MemberProfileResponse response,String PhoneNumber,
                                 SpecificOfferingStatement statement){
