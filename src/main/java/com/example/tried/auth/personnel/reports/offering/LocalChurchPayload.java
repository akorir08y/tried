...
public class LocalChurchPayload{
	...
	public LocalChurchPayload() {
	}

	public LocalChurchPayload(String churchName, String endDate, String churchCode, String meansOfPayment, String startDate, String group) {
