...
public class Rpayload{
	...
	public Rpayload(Integer amount, String mSISDN, Integer sessionNumber, String paymentMode, String accountName, ExtraData extraData, String countryCode, String narration, String customerNames, String accountNumber, String accessPoint, String datePaymentReceived) {
		this.amount = amount;
		this.mSISDN = mSISDN;
