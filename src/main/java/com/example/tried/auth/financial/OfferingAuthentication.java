...
public class OfferingAuthentication {
	...
	public OfferingAuthentication() {
	}

	public OfferingAuthentication(String personnelName, String password, String institutionNumber, String institutionLevel, String phoneNumber, Integer sessionNumber, String pin, String institutionName, String user) {
