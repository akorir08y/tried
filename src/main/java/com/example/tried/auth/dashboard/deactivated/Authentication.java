...
public class Authentication{
	...
	public Authentication(String personnelName, String password, String institutionNumber, String institutionLevel, Long sessionNumber, String institutionName, String user) {
		this.personnelName = personnelName;
		this.password = password;
		this.institutionNumber = institutionNumber;
		this.institutionLevel = institutionLevel;
