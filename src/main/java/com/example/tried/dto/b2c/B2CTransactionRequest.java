...
public class B2CTransactionRequest {
	...
	public B2CTransactionRequest(String queueTimeOutURL, String remarks, int amount, String initiatorName, String securityCredential, String occassion, String commandID, int partyA, long partyB, String resultURL) {
